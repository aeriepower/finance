        ...
        <section class="tips">
            <div class="row">
                <article class="col-lg-4">
                    <img src="https://cdn1.iconfinder.com/data/icons/business-and-finance-20/200/vector_65_14-128.png" alt="Charts">
                    <h3>Lorem</h3>
                    <p>{{ trans('landingPage.lorem') }}</p>
                </article>
                <article class="col-lg-4">
                    <img src="https://cdn1.iconfinder.com/data/icons/business-and-finance-20/200/vector_65_04-128.png" alt="Money">
                    <h3>Lorem</h3>
                    <p>{{ trans('landingPage.lorem') }}</p>
                </article>
                <article class="col-lg-4">
                    <img src="https://cdn1.iconfinder.com/data/icons/business-and-finance-20/200/vector_65_07-128.png" alt="Save">
                    <h3>Lorem</h3>
                    <p>{{ trans('landingPage.lorem') }}</p>
                </article>
            </div>
